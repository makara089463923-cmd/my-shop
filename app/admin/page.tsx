  ...
  return (
    <div className="space-y-4 sm:space-y-6">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
        ...
        <Link
          href="/admin/home"
          className="inline-flex items-center gap-2 bg-white rounded-lg shadow-sm hover:shadow-md transition-all px-4 py-2 border border-gray-100 hover:border-pink-200 text-sm font-medium text-gray-700 hover:text-pink-600"
        >
          🏠 កែប្រែ Home Page
        </Link>
      </div>
